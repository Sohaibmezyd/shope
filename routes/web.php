...
Route::get('/admin/print/show/{id}', 'admin\OrdersController@printshow' );
...
Route::group([ 'middleware' => 'ProjectGlobal' ],function(){
 ...
 Route::get('/contact', 'PagesController@contact' );
  ...
  Route::get('/admin', 'admin\DashboardController@index2' );
    ...
    Route::post('/push/paypal', 'PushController@paypal' );
    Route::post('/push/card', 'PushController@card' );
    Route::post('/push/end', 'PushController@end' );
