...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <span class="m-nav__link-text">إضافة منتج جديد</span>
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('')); ?>/admin/products/store" enctype="multipart/form-data">
			...
			<div class="m-portlet m-portlet--tabs">
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">أضف منتج </button>
...
<?php echo $__env->make('admin.layout',['title' => 'Add a new product'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>