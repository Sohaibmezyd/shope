...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <span class="m-nav__link-text">أضف صفحة جديدة</span>
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('')); ?>/admin/pages/store">
			...
			<div class="m-portlet m-portlet--tabs">
              ...
              <div class="col-10">
                ...
                <input type="text" id="link" class="form-control m-input" name="link" value="<?php echo e(old('link')); ?>">
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">إضافة صفحة </button>
...
<?php echo $__env->make('admin.layout',['title' => 'Add new page'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>