										...
										<div class="col-lg-offset-6 col-lg-6 col-md-offset-4 col-md-8">
											...
											<div class="cart-totals clearfix">
												...
												<div class="ct-left" style="border-right: 0px;">
													...
													<h2> <span id="totalPriceAfterDiscount"><?php echo e($cart->cartTotalWithIcon()); ?></span>|المبلغ الإجمالي</h2>
											...
											<div class="cart-action clearfix">
												...
												<a href="<?php echo e(url('/')); ?>" class="btn btn-primary">استكمال الشراء</a>

												<a href="<?php echo e(url('/checkout')); ?>" class="btn btn-primary">الدفع</a>
