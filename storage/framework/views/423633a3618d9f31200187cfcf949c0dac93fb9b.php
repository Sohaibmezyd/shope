...
<button type="button" data-role="none" class="slick-next slick-arrow" aria-label="Next" role="button" style="display: block;">التالي</button></ul>
</div>
<?php endif; ?>
...
<h5 class="sub-title">لمحة سريعة</h5>
...
<button class="btn btn-common"><i class="icon-basket-loaded-loaded"></i> اضف الى السلة</button>
  </a>
</div>
...
<a href="<?php echo e($setting->linkedIn); ?>"><i class="fa fa-linkedin"></i></a>
</div>
</div>
</div>
</div>
