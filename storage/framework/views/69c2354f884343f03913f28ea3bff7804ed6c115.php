...
<div class="container">
 ...
 <?php echo e(csrf_field()); ?>
          ...
          <h2 class="title-checkout"><i class="icon-user"></i>الاسم و العنوان</h2>
          ...
          <h2 class="title-checkout"><i class="icon-basket-loaded-loaded"></i>طلباتك</h2>
          ...
          <button  type="submit" class="btn btn-common btn-full">الدفع الآن <span class="icon-action-redo"></span></button>
          </div>
