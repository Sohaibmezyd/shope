...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">أشرطة التمرير</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">أشرطة التمرير</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<?php echo $__env->make('admin.layout',['title' => 'Sliders'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>