...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">الضبط</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">الضبط</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                {{ csrf_field() }}
                    ...
                    <table class="table table-hover table-responsive" width="100%">
                      ...
                      <table class="table-total-checkout">
                        <button  type="submit" class="btn btn-primary btn-sm" style="float : right" >حفظ  </button>
