                    ...
                    <table class="table table-hover table-responsive" width="100%" style="text-align:center;">
                        ...
                        @if( $products )
                            ...
                            <tr>
                                ...
                                <td>{{ $product->title }}</td>
                                <td>{{ $product->price }}</td>
                                <td>{!! $product->status == 1 ? '<span class="m-badge m-badge--success m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-success">نشيط</span>' : '<span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger">غير نشط</span>' !!}</td>
                                <td>
