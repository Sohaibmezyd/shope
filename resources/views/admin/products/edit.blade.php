...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                           ...
                           <span class="m-nav__link-text">تعديل المنتج</span>
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="{{ url('admin/products/update/' . $product->id ) }}" enctype="multipart/form-data">
			...
			<div class="m-portlet m-portlet--tabs">
			    ...
			    <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
    									...
    									<label for="tower_title" class="col-2 col-form-label">إسم المنتج  :</label>

    									<div class="col-10">

    										<input type="text" id="title" class="form-control m-input" name="title" value="{{ $product->title}}">
                    ...
                    <div class="form-group m-form__group row">
    									...
    									<label for="tower_title" class="col-2 col-form-label">الفئة  :</label>
								 ...
								 <div class="form-group m-form__group row m--margin-top-40">
									...
									<div class="col-10">
										...
										<span class="m-switch m-switch--lg m-switch--info m-switch--icon">
						                        ...
						                        <input type="checkbox" {{ $product->status == 1 ? 'checked="checked"' : '' }} name="status" value="1">
                ...
                <div class="form-group m-form__group row m--margin-top-40">
                  ...
                  <label for="pageTitle" class="col-2 col-form-label">منتجات مميزة  :</label>
                        ...
                        <label>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-10">
										...
										<input type="text" id="price" class="form-control m-input" name="price" value="{{ $product->price}}">
                ...
                <div class="form-group m-form__group row">
									...
									<label for="after_discount" class="col-2 col-form-label">السعر بعد الخصم :</label>

									<div class="col-10">

										<input type="text" id="after_discount" class="form-control m-input" name="after_discount" value="{{ $product->after_discount}}">
                ...
                <div class="form-group m-form__group row">
									...
									<label for="after_discount" class="col-2 col-form-label">اضف صورة :</label>
