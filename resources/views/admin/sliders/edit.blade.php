    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
                ...
                <h3 class="m-subheader__title m-subheader__title--separator">شريط التمرير</h3>
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="{{ url('admin/sliders') }}" class="m-nav__link">
                            ...
                            <span class="m-nav__link-text">شريط التمرير</span>
                    ...
                    <li class="m-nav__item">
                           ...
                           <span class="m-nav__link-text">تعديل شريط التمرير</span>
