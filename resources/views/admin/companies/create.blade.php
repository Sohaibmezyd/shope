    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
                ...
                <h3 class="m-subheader__title m-subheader__title--separator">شركة</h3>
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="{{ url('') }}/admin/companies" class="m-nav__link">
                            ...
                            <span class="m-nav__link-text">شركة</span>
                    ...
                    <li class="m-nav__item">
                        ...
                        <span class="m-nav__link-text">إضافة شركة جديدة</span>
		...
		<form class="m-form" method="post" action="{{ url('') }}/admin/companies/store" enctype="multipart/form-data">
			...
			<div class="m-portlet m-portlet--tabs">
			        	...
			        	<div class="tab-content prodHeadz">
			        		...
			        		<div class="tab-pane active" role="tabpanel" id="general-tb">
			        			...
			        			<div class="form-group m-form__group row">
									...
									<label for="name" class="col-2 col-form-label">اسم الشركة :</label>
                ...
                <div class="form-group m-form__group row">
                  ...
                  <label for="after_discount" class="col-2 col-form-label">إضافة صورة :</label>
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">أضف شركة </button>
