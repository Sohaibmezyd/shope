    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
                ...
                <h3 class="m-subheader__title m-subheader__title--separator">الزبون</h3>
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="{{ url('') }}/admin/users" class="m-nav__link">
                            ...
                            <span class="m-nav__link-text">الزبون</span>
                    ...
                    <li class="m-nav__item">
                           ...
                           <span class="m-nav__link-text">تعديل بيانات الزبون</span>
    ...
    <div class="m-subheader ">
      ...
      <input type="hidden" name="id" value="{{ $user->id }}" />
			...
			<div class="m-portlet m-portlet--tabs">
              ...
              <label for="tower_name" class="col-2 col-form-label">اسم الزبون  :</label>
            ...
            <div class="form-group m-form__group row m--margin-top-40">
              ...
              <label for="pageTitle" class="col-2 col-form-label">مشرف  :</label>
          ...
          <label for="email" class="col-2 col-form-label">البريد الإلكتروني  :</label>
      ...
      <label for="phone" class="col-2 col-form-label">الهاتف  :</label>
      ...
      <div class="col-10">
        ...
        <label for="password" class="col-2 col-form-label">كلمه السر  :</label>
    ...
    <!-- media -->
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">فحظ التعديل </button>
